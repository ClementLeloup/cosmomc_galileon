    ...
    Type TCosmoTheoryParams
        ...
        logical :: use_galileon = .false. !whether to use galileon cosmology or not
    ...
    !Modified by Clement Leloup
    call Ini%Read('use_galileon', CosmoSettings%use_galileon)
    if(CosmoSettings%use_galileon) print *, "NOTE: galileon mode"
